...
<body class="start_">
  ...
  <div id="main">
    <section id="banner">
      <h2>Europe En Marche est une association de pédagogie sur les questions ayant trait à l'Union européenne.</h2>
      <!-- Begin MailChimp Signup Form -->
        <form id="nl" action="//europe-en-marche.us15.list-manage.com/subscribe/post?u=afdf5656116858e389041e0ef&amp;id=cccc28de89" method="post" id="mc-embedded-subscribe-form" target="_blank" novalidate>
            <input type="submit" value="Je m'inscris à la newsletter !" name="subscribe" class="button">
          <!--
            <label>Je m'inscris à la newsletter :</label>
            <div class="row">
              <input type="email" value="" name="EMAIL" class="email" placeholder="adresse électronique" required>
              <input type="submit" value="OK" name="subscribe" class="button">
            </div>
              -->
            <div style="position: absolute; left: -5000px;" aria-hidden="true">
              <input type="text" name="b_afdf5656116858e389041e0ef_cccc28de89" tabindex="-1" value="">
            </div>
        </form>
      <!--End mc_embed_signup-->
        <h3>Vous pouvez découvrir notre tribune fondatrice ci-dessous.</h3>
    </section>
      ...
      <div id="forms" class="">
        <div class="container">
          ...
          <form id="share" onsubmit="return false;">
            ...
            <div>
              <button class="share twitter" onclick="Forms.shareTwitter();">JE PARTAGE SUR <i>TWITTER</i></button>

              <button class="share facebook" onclick="Forms.shareFacebook();">JE PARTAGE SUR <i>FACEBOOK</i></button>
            </div>
          </form>
